...
function wc_custom_rewards_admin_page_html() {
  ...
  if ( isset( $_POST['wc_custom_rewards_user_id'] ) && isset( $_POST['wc_custom_rewards_balance'] ) ) {
      ...
      echo '<div class="updated"><p>' . __( 'تم تحديث رصيد المستخدم بنجاح.', 'wc-custom-rewards' ) . '</p### 1. **تحديث عرض الرصيد في الحساب:**
في ملف `includes/functions.php`، تأكد من أن الكود التالي موجود لعرض الرصيد في صفحة الحساب:'
